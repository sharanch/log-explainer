...
This triggers the Docker and Package workflows simultaneously. The GitHub Releases page will have the `.app`, `.deb`, `.rpm` attached, and the Docker image will be tagged `v1.0.0` on GHCR.
